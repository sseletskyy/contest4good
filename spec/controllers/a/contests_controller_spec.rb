  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created contest" do
        post :create, {:contest => valid_attributes}, valid_session
        response.should redirect_to(a_contest_url(Contest.last))
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contest as @contest" do
        ...
        post :create, {:contest => {"name" => "invalid value"}}, valid_session
        assigns(:contest).should be_a_new(Contest)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contest" do
        ...
        Contest.any_instance.should_receive(:update).with({"name" => "MyString"})
        put :update, {:id => contest.to_param, :contest => {"name" => "MyString"}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contest as @contest" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contest.any_instance.stub(:save).and_return(false)
        put :update, {:id => contest.to_param, :contest => {"name" => "invalid value"}}, valid_session
        assigns(:contest).should eq(contest)
      end
